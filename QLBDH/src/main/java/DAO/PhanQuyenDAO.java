...
//
//                // Quyền cũ (nếu vẫn còn trong CSDL, có thể bỏ qua nếu không dùng nữa)
...
//        if (getPhanQuyen(pq.getTenQuyen()) != null) {
...
//        "Quyen, " +
//        "NS_XemDanhSach, NS_Them, NS_Sua, NS_Xoa, NS_DuyetNghi, NS_ThayDoiChucVu, NS_TinhLuong, NS_XemLuongCaNhan, NS_InBangLuong, " +
//        "KHO_XemSanPham, KHO_ThemSanPham, KHO_SuaSanPham, KHO_XoaSanPham, KHO_NhapHang, KHO_QuanLyNCC, KHO_BaoCaoTonKho, " +
//        "BH_LapPhieuXuat, BH_ThongKeDoanhThu, BH_ThongKeLoiNhuan, " +
//        "PQ_QuanLyPhanQuyen, Admin_BaoCaoTongHop" +
//        ") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
//        try {
//            // Thực hiện INSERT
//            int rows = DataProvider.executeUpdate(sql,
//                pq.getTenQuyen(),            // Tham số 1: Tên Quyen
//                pq.isNsXemDanhSach(), pq.isNsThem(), pq.isNsSua(), pq.isNsXoa(), pq.isNsDuyetNghi(), pq.isNsThayDoiChucVu(), pq.isNsTinhLuong(), pq.isNsXemLuongCaNhan(), pq.isNsInBangLuong(),
//                pq.isKhoXemSanPham(), pq.isKhoThemSanPham(), pq.isKhoSuaSanPham(), pq.isKhoXoaSanPham(), pq.isKhoNhapHang(), pq.isKhoQuanLyNCC(), pq.isKhoBaoCaoTonKho(),
//                pq.isBhLapPhieuXuat(), pq.isBhThongKeDoanhThu(), pq.isBhThongKeLoiNhuan(),
//                pq.isPqQuanLyPhanQuyen(), pq.isAdminBaoCaoTongHop()         
//            );
//            return rows > 0;
//        } catch (Exception e) {
//            e.printStackTrace();
