...
public class PnChamCong extends JPanel {
    ...
    private void loadData() {
        ...
        for (int day = 1; day <= maxDay; day++) {
            ...
            if (cc == null) {
                ...
                if ("Đi làm".equals(trangThaiHienThi)) {
                    trangThaiHienThi = "✅ " + trangThaiHienThi;
                } else if ("Đi muộn".equals(trangThaiHienThi)) {
                    trangThaiHienThi = "⚠️ " + trangThaiHienThi;
                } else if ("Nghỉ có phép".equals(trangThaiHienThi)) {
                    trangThaiHienThi = "📝 " + trangThaiHienThi;
                } else if ("Nghỉ không phép".equals(trangThaiHienThi)) {
                    trangThaiHienThi = "❌ " + trangThaiHienThi;
                }
    ...
    private void configureByPermission() {
        ...
        if (isQuanLy) {
            ...
            btnSua.setVisible(false);   // Cho phép sửa chấm công của mình
