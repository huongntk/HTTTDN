...
//    private void loadSanPhamDaXuat(int thang, int quy, int nam) {
//    DefaultTableModel model = (DefaultTableModel) tblSanPhamXuat.getModel();
//    model.setRowCount(0);
//    
//    ArrayList<Map<String, Object>> data = thongKeBUS.thongKeSanPhamDaXuat(thang, quy, nam);
//    
//    if (data == null || data.isEmpty()) {
//        JOptionPane.showMessageDialog(this, "Không có dữ liệu sản phẩm đã xuất trong kỳ.", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
//        return;
//    }
//    
//    for (Map<String, Object> row : data) {
...
//            row.get("TenSP"),
//            row.get("ThuongHieu"),
//            String.format("%,d", ((Number) row.getOrDefault("SoLuongDaBan", 0)).intValue()),
//            currencyFormat.format(row.get("DoanhThu")),
//            currencyFormat.format(row.get("GiaBanTrungBinh"))
//        });
//    }
//}
